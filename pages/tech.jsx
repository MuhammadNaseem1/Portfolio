...
const tech = () => {
  const data = [
    ...
    },
    {
      ...
      desc: "A JavaScript runtime built on Chrome's V8 engine for building fast, scalable backend services and APIs.",
      tag: "develop",
      bg: "bg-green-50",
      text: "text-green-600",
    },
    {
      title: "C# / .NET",
      id: 14,
      main: "/icons/csharp-original.svg",
      desc: "Microsoft's C# language and ASP.NET Core framework, used for building scalable, high-performance backend services.",
      tag: "develop",
      bg: "bg-purple-50",
    ...
    },
    {
      ...
      desc: "An enterprise-grade relational database used for complex queries, stored procedures, and performance tuning.",
      tag: "develop",
      bg: "bg-red-50",
      text: "text-red-600",
    },
    {
      ...
      desc: "A minimal and flexible Node.js web application framework for building APIs and backend services.",
      tag: "develop",
      bg: "bg-gray-900",
      text: "text-gray-50",
    },
    {
      title: "MongoDB",
      id: 17,
      main: "/icons/mongodb-plain.svg",
      desc: "A NoSQL document database used for flexible, scalable data storage in modern applications.",
      tag: "develop",
      bg: "bg-green-50",
      text: "text-green-600",
    },
