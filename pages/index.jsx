...
export default function Home() {
  ...
  useEffect(() => {
    ...
    console.log.apply(console, [
      "%c Designed and Developed by Muhammad Naseem %c %c🚀 %c\n",
  ...
  return (
    <>
      <Head>
        <title>Naseem ✦ developer, designer</title>
          ...
          <div className="flex flex-row justify-start items-center mt-20">
            ...
            <div className="flex flex-col ml-4">
              <h2 className="flex sm:text-2xl md:text-2xl lg:text-2xl">
                <span className="font-semibold">Muhammad Naseem</span>
                <span>
                  <Image
              ...
              <h3>
                <Link
                  href={"https://www.linkedin.com/in/muhammadnaseem1/"}
                  target="_blank"
